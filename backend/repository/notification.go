...
func (r *PersonalNotificationRepository) GetUserNotifications(userID uint, page, pageSize int) ([]models.PersonalNotification, int64, error) {
...
func (r *PersonalNotificationRepository) MarkAllRead(userID uint) error {
	return r.db.Model(&models.PersonalNotification{}).Where("user_id = ?", userID).Update("is_read", true).Error
}
