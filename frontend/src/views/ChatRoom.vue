<script setup>import { ref, inject, onMounted, onUnmounted, nextTick } from 'vue';
...
<template>
  <v-app>
    <v-app-bar app>
      ...
      <v-toolbar-title>{{ targetUser?.display_name || targetUser?.friend?.username || '聊天' }}</v-toolbar-title>
    </v-app-bar>

    <v-container class="h-full" style="height: calc(100vh - 140px);">
      <!-- 消息列表 -->
